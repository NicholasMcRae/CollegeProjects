...
/********************************************************
Purpose: FTP Client - app has the ability to either receive all the files in a directory from the server application, or send all the files in a directory to the server application.
