...
/********************************************************
Purpose: Socket library header file, written to be a thin client that takes care of the basic maintenance of socket functions
Authors: Nick McRae / Milan Sobat
Revision History:
March 22-23rd/2014 - Built socket library and got it functional with the server
April 5-6th/2014 - Updated library logic to work with the client
*********************************************************/
